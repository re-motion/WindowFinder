...
{
  [TestFixture]
  public class NativeWindowFinderTest_FilterByWindowText : NativeWindowFinderTestBase
  {
    [Test]
    public void FindWindows ()
    {
      ...
      StubNativeMethodsForWindowInformation (NativeMethodsStub, windowHandle1, 101, "Class1", "xWindow1");
      StubNativeMethodsForWindowInformation (NativeMethodsStub, windowHandle2, 201, "Class2", "Window1x");
      StubNativeMethodsForWindowInformation (NativeMethodsStub, windowHandle3, 301, "Class3", "Window3");

      var windows = WindowFinder.FindWindows (new WindowFilterCriteria { WindowTitle = new Regex ("Window1") });

      Assert.That (windows.Length, Is.EqualTo (2));
      AssertWindowInformation (windows[0], windowHandle1, 101, "Class1", "xWindow1");
      AssertWindowInformation (windows[1], windowHandle2, 201, "Class2", "Window1x");
    }
    ...
    public void FindWindows_IncludeChildWindows_MatchesParentAndChild ()
    {
      ...
      var windows = WindowFinder.FindWindows (new WindowFilterCriteria { IncludeChildWindows = true, WindowTitle = new Regex ("Window1") });
