...
{
  /// <summary>
  /// Contains all information required by <see cref="EnumWindowsProc"/>.
  /// </summary>
  public sealed class WindowFinderEnumWindowsProcContext : WindowFinderEnumWindowsProcContextBase
  {
    private readonly int? _ownProcessIDConstraint;
    private readonly int? _processIDConstraint;
    ...
    public int? OwnProcessIDConstraint
    {
      get { return _ownProcessIDConstraint; }
    }

    public int? ProcessIDConstraint
    {
      get { return _processIDConstraint; }
    }

    public bool IncludeChildWindows
    {
      get { return _includeChildWindows; }
    }
  }
}